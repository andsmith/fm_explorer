...
class FMSynthesizer(object):
    def __init__(self, rate=44100.0, sample_width=2, carrier_init=(220.0, 0.5), modulation_init=(1.0, 0.0)):
        self._rate = rate
    ...
    def param_str(self):
        return "C_f = %.3f Hz, C_a = %.2f %%, M_f = %.3f Hz. M_d = %.2f" % (self._carrier_freq,
